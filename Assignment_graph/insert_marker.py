...
def insert_New_Node(marker_ID, marker_name, latitude, longitude, mardiscriptionker_ID, link, marker_color, icon):
    try:
...
insert_New_Node(None ,marker_name, latitude, longitude, discription, link, marker_color, icon)